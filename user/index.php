...
// Check if a valid session exists and the login type is not "admin"
if (!isset($_SESSION['login_type']) || $_SESSION['login_type'] !== 'user') {
    // Redirect to the admin login page
    header("Location: admin/login.php"); // Replace with the actual admin login page URL
    exit();
}
...
<?php require_once('inc/header.php') ?>
  <body class="sidebar-mini layout-fixed control-sidebar-slide-open layout-navbar-fixed sidebar-mini-md sidebar-mini-xs" data-new-gr-c-s-check-loaded="14.991.0" data-gr-ext-installed="" style="height: auto;">
    <div class="wrapper">
     ...
     <?php $page = isset($_GET['page']) ? $_GET['page'] : 'expense';  ?>
